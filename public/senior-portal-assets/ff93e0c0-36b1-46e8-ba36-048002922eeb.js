...
const PORTALS = {
  ...
  learner: {
    ...
    renewal: '7 mo left',
    meter: 42,
    nextLessonHref: 'Lesson Player.html?lesson=M-1-01',
    ...
    dash: {
      ...
      upnext: [
        { d: '18', m: 'MAY', t: 'PREP Framework', s: 'Learn the 4-part prompt recipe', cta: 'Play', href: 'Lesson Player.html?lesson=M-1-03' },
  ...
  operator: {
    ...
    renewal: '9 mo left',
    meter: 78,
    nextLessonHref: 'Lesson Player.html?lesson=M-2-04',
    ...
    dash: {
      ...
      upnext: [
        ...
        { d: '22', m: 'MAY', t: 'Lesson · AUP Module', s: 'M-2-04 · with Sgt. Meridian', cta: 'Resume', href: 'Lesson Player.html?lesson=M-2-04' },
        { d: '06', m: 'JUN', t: 'Road Test · Class O', s: 'Final assessment · 5 scenarios', cta: 'Start', href: 'Road Test.html' },
      ],
  ...
  specialist: {
    ...
    renewal: '6 mo left',
    meter: 61,
    nextLessonHref: 'Lesson Player.html?lesson=M-3-03',
    ...
    dash: {
      ...
      upnext: [
        { d: '18', m: 'MAY', t: 'STRIDE-AI Risk Register', s: 'ProdSight pre-launch red-team', cta: 'Open', href: 'Lesson Player.html?lesson=M-3-03' },
        { d: '22', m: 'MAY', t: 'Authoring the AI Charter', s: 'M-3-06 · capstone rehearsal', cta: 'Play', href: 'Lesson Player.html?lesson=M-3-06' },
  ...
  document.getElementById('view-dashboard').innerHTML = `
    <div class="head">
      ...
      <div style="display:flex; gap: 10px; flex-wrap: wrap; justify-content:flex-end;">
        ...
        <a class="btn btn-red" href="Road Test.html">Take Road Test →</a>
      </div>
    </div>
