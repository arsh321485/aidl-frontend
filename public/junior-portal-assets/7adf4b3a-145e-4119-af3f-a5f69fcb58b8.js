...
const TIERS = {
  ...
  cadet: {
    ...
    upnext: [
      ...
      { d: '22', m: 'MAY', t: 'Lesson · Meet Your AI Buddy', s: 'Play the next lesson with Driver Ed', cta: 'Play', href: 'Lesson Player.html', btn: 'btn-yellow' },
  ...
  crew: {
    ...
    upnext: [
      ...
      { d: '22', m: 'MAY', t: 'Build-a-Bot · part 2', s: 'Continue your helper bot project', cta: 'Resume', href: 'Lesson Player.html', btn: 'btn-yellow' },
  ...
  document.getElementById('view-dashboard').innerHTML = `
    <div class="head">
      ...
      <div style="display:flex; gap:10px;">
        ...
        <a class="btn btn-yellow" href="Lesson Player.html">Play Next Lesson →</a>
